    ...
    <section className="max-w-[920px] mx-auto px-4 sm:px-6 md:px-8 py-10 md:py-14 animate-fade-in">
      ...
      <div className="space-y-8 text-on-surface font-body leading-7">
        ...
        <section>
          ...
          <p>
            We use data to authenticate accounts, support student email
            verification flows, assign and enforce role-based permissions,
            deliver relevant deals, prevent fraud, respond to support requests,
            and improve service reliability and user experience.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            transit and at rest through our infrastructure providers.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            Protection Act where applicable, you may request access, correction,
            or deletion of your personal information. You may also request
