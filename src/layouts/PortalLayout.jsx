...
function PortalLayout({ children, portalType = "partner", brandName = "" }) {
  ...
  const adminLinks = [
    ...
    { path: "/admin/finished-deals", label: "Finished Deals", icon: "history" },
    { path: "/admin/events", label: "All Events", icon: "event" },
    { path: "/admin/finished-events", label: "Finished Events", icon: "event_busy" },
  ...
  const partnerLinks = [
    ...
    { path: "/partner/finished-deals", label: "Finished Deals", icon: "history" },
    { path: "/partner/create-deal", label: "Create Deal", icon: "add_circle" },
    { path: "/partner/events", label: "My Events", icon: "event" },
    { path: "/partner/finished-events", label: "Finished Events", icon: "event_busy" },
    { path: "/events/new", label: "Create Event", icon: "event_available" },
